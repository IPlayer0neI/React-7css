 ...
 * @property {string[]} [props.list] A list of "input" elements with type="radio" inside an element with class "field-row".
 * @property {string} [props.name] "name" property for "input" elements.
 */
