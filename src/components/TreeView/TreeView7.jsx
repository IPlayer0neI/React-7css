 ...
 * @property {boolean} [props.collapse=false] The has-collapse-button class can be used to change the expand/collapse cursors for buttons.
 * @property {boolean} [props.connector=false] The connector value may be used to render a dotted border to illustrate the structure more clearly.
 * @property {boolean} [props.container=true] Adds the "has-container" class.
 * @property {boolean} [props.root=false] Adds the "tree-view" class.
